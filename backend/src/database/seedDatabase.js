  ...
  try {
    ...
    const islands = [
      ...
      },
      {
        ...
        latitude: -17.7134,
        longitude: 178.0650,
        marine_latitude: -18.1500,
        marine_longitude: 177.7000
      }
    ]
    ...
    const species = [
      { id: 1, name: 'Green Sea Turtle', category: 'turtle', scientific_name: 'Chelonia mydas', conservation_status: 'Endangered', habitats: 'Coral Reef, Seagrass Meadow, Lagoon', min_depth: 1, max_depth: 30, description: 'A gentle marine turtle commonly seen around coral reefs and seagrass beds.', image_url: speciesImage('green-sea-turtle', 'green-sea-turtle.jpg'), tags: 'Herbivore,Friendly,Reef', api_source: 'manual', external_id: null },
      { id: 2, name: 'Whale Shark', category: 'shark', scientific_name: 'Rhincodon typus', conservation_status: 'Endangered', habitats: 'Open Water, Reef Slope, Plankton-Rich Channel', min_depth: 0, max_depth: 50, description: 'The largest fish in the ocean, often seen in warm tropical waters.', image_url: speciesImage('whale-shark', 'whale-shark.jpg'), tags: 'Gentle Giant,Pelagic,Filter Feeder', api_source: 'manual', external_id: null },
      { id: 3, name: 'Clownfish', category: 'fish', scientific_name: 'Amphiprioninae', conservation_status: 'Least Concern', habitats: 'Coral Reef, Anemone Garden, Shallow Lagoon', min_depth: 1, max_depth: 15, description: 'A small reef fish commonly found living among sea anemones.', image_url: speciesImage('clownfish', 'clownfish.jpg'), tags: 'Reef,Small Fish,Anemone', api_source: 'manual', external_id: null },
      { id: 4, name: 'Reef Manta Ray', category: 'ray', scientific_name: 'Mobula alfredi', conservation_status: 'Vulnerable', habitats: 'Cleaning Station, Reef Slope, Open Water', min_depth: 5, max_depth: 40, description: 'A graceful ray often seen gliding through tropical reefs and cleaning stations.', image_url: speciesImage('reef-manta-ray', 'reef-manta-ray.jpg'), tags: 'Gentle,Reef,Open Water', api_source: 'manual', external_id: null },
      { id: 5, name: 'Blacktip Reef Shark', category: 'shark', scientific_name: 'Carcharhinus melanopterus', conservation_status: 'Vulnerable', habitats: 'Reef Flat, Lagoon Edge, Reef Slope', min_depth: 1, max_depth: 75, description: 'A reef-associated shark commonly spotted around coral slopes and lagoon edges.', image_url: speciesImage('blacktip-reef-shark', 'blacktip-reef-shark.jpg'), tags: 'Predator,Reef,Fast Swimmer', api_source: 'manual', external_id: null },
      { id: 6, name: 'Blue Tang', category: 'fish', scientific_name: 'Paracanthurus hepatus', conservation_status: 'Least Concern', habitats: 'Coral Reef, Reef Crest, Lagoon', min_depth: 2, max_depth: 40, description: 'A bright blue reef fish known for vivid colour and active swimming behaviour.', image_url: speciesImage('blue-tang', 'blue-tang.jpg'), tags: 'Reef,Colourful,Small Fish', api_source: 'manual', external_id: null },
      { id: 7, name: 'Parrotfish', category: 'fish', scientific_name: 'Scarinae', conservation_status: 'Least Concern', habitats: 'Coral Reef, Reef Flat, Seagrass Edge', min_depth: 1, max_depth: 30, description: 'A colourful reef fish that helps maintain coral reef health by grazing algae.', image_url: speciesImage('parrotfish', 'parrotfish.jpg'), tags: 'Herbivore,Reef,Colourful', api_source: 'manual', external_id: null },
      { id: 8, name: 'Brain Coral', category: 'coral', scientific_name: 'Diploria labyrinthiformis', conservation_status: 'Near Threatened', habitats: 'Shallow Reef, Reef Flat, Coral Garden', min_depth: 1, max_depth: 30, description: 'A hard coral named for its maze-like surface pattern, often found in shallow reefs.', image_url: speciesImage('brain-coral', 'brain-coral.jpg'), tags: 'Coral,Reef Builder,Slow Growing', api_source: 'manual', external_id: null },
      { id: 9, name: 'Sea Anemone', category: 'other', scientific_name: 'Actiniaria', conservation_status: 'Not Evaluated', habitats: 'Anemone Garden, Coral Reef, Rocky Crevice', min_depth: 1, max_depth: 25, description: 'A soft-bodied marine animal often associated with clownfish and reef ecosystems.', image_url: speciesImage('sea-anemone', 'sea-anemone.jpg'), tags: 'Reef,Symbiosis,Clownfish Habitat', api_source: 'manual', external_id: null },
      { id: 10, name: 'Moon Jellyfish', category: 'jellyfish', scientific_name: 'Aurelia aurita', conservation_status: 'Not Evaluated', habitats: 'Coastal Water, Lagoon, Calm Bay', min_depth: 0, max_depth: 20, description: 'A translucent jellyfish often seen drifting slowly in calm coastal waters.', image_url: speciesImage('moon-jellyfish', 'moon-jellyfish.jpg'), tags: 'Drifter,Soft Body,Coastal', api_source: 'manual', external_id: null },
      { id: 11, name: 'Hawksbill Turtle', category: 'turtle', scientific_name: 'Eretmochelys imbricata', conservation_status: 'Critically Endangered', habitats: 'Coral Reef, Sponge Garden, Reef Slope', min_depth: 1, max_depth: 40, description: 'A reef turtle with a narrow beak that often feeds around coral and sponge habitats.', image_url: speciesImage('hawksbill-turtle', 'hawksbill-turtle.jpg'), tags: 'Turtle,Reef,Endangered', api_source: 'manual', external_id: null },
      { id: 12, name: 'Great Barracuda', category: 'fish', scientific_name: 'Sphyraena barracuda', conservation_status: 'Least Concern', habitats: 'Drop-off, Reef Edge, Open Water', min_depth: 2, max_depth: 50, description: 'A sleek predatory fish that may gather in striking schools around reef drop-offs.', image_url: speciesImage('great-barracuda', 'great-barracuda.jpg'), tags: 'Predator,Schooling,Reef Edge', api_source: 'manual', external_id: null },
      { id: 13, name: 'Moorish Idol', category: 'fish', scientific_name: 'Zanclus cornutus', conservation_status: 'Least Concern', habitats: 'Coral Reef, Rocky Reef, Lagoon', min_depth: 1, max_depth: 30, description: 'A distinctive reef fish with bold black, white, and yellow bands.', image_url: speciesImage('moorish-idol', 'moorish-idol.jpg'), tags: 'Reef,Colourful,Iconic', api_source: 'manual', external_id: null },
      { id: 14, name: 'Giant Clam', category: 'other', scientific_name: 'Tridacna gigas', conservation_status: 'Vulnerable', habitats: 'Reef Flat, Coral Garden, Shallow Lagoon', min_depth: 1, max_depth: 20, description: 'A large reef-dwelling clam with colourful mantle tissue and a symbiotic relationship with algae.', image_url: speciesImage('giant-clam', 'giant-clam.jpg'), tags: 'Reef,Filter Feeder,Shellfish', api_source: 'manual', external_id: null },
      ...
      { id: 16, name: 'Table Coral', category: 'coral', scientific_name: 'Acropora hyacinthus', conservation_status: 'Near Threatened', habitats: 'Reef Crest, Coral Garden, Shallow Reef', min_depth: 2, max_depth: 25, description: 'A broad table-shaped coral that shelters reef fish and creates layered reef structure.', image_url: speciesImage('table-coral', 'table-coral.jpg'), tags: 'Coral,Reef Builder,Plate Coral', api_source: 'manual', external_id: null },
      { id: 17, name: 'Eagle Ray', category: 'ray', scientific_name: 'Aetobatus narinari', conservation_status: 'Endangered', habitats: 'Sandy Bottom, Lagoon, Reef Edge', min_depth: 1, max_depth: 60, description: 'A spotted ray often seen cruising over sandy bottoms and reef edges.', image_url: speciesImage('eagle-ray', 'eagle-ray.jpg'), tags: 'Ray,Graceful,Sandy Bottom', api_source: 'manual', external_id: null },
      { id: 18, name: 'Blue Sea Star', category: 'other', scientific_name: 'Linckia laevigata', conservation_status: 'Not Evaluated', habitats: 'Reef Flat, Coral Rubble, Lagoon', min_depth: 1, max_depth: 20, description: 'A vivid blue sea star often found on reef flats and coral rubble.', image_url: speciesImage('blue-sea-star', 'blue-sea-star.jpg'), tags: 'Reef,Invertebrate,Colourful', api_source: 'manual', external_id: null },
      { id: 19, name: 'Napoleon Wrasse', category: 'fish', scientific_name: 'Cheilinus undulatus', conservation_status: 'Endangered', habitats: 'Reef Slope, Drop-off, Coral Reef', min_depth: 2, max_depth: 60, description: 'A large charismatic reef fish recognized by its forehead hump and bold patterning.', image_url: speciesImage('napoleon-wrasse', 'napoleon-wrasse.jpg'), tags: 'Large Fish,Reef,Endangered', api_source: 'manual', external_id: null },
